...
// Updated file on 10th Jan 2017 with this empty comment.
...
// Begin locale-compiled/en_US.js
        ZLoc.init("en_US", {"Inbox":{"listNames":{"original":"{commaDelimNames} and {finalName}"},"followUpCTASendGiftBack":{"original":"Send a gift back"},"followUpCTASendGift":{"original":"Send a gift"},"followUpInviteTitle":{"original":"You are now neighbors with {listNames}."},"followUpInviteBody":{"original":"Would you like to say hello by sending a gift of {gift}?"},"followUpGiftBody":{"original":"Send a thank you gift back to {listNames}?"},"followUpFriendBody":{"original":"Send a {gift} to {listNames}?"},"formatCTAAccept":{"original":"Accept"},"formatCTAAcceptAll":{"original":"Accept All"},"formatCTAAcceptSee":{"original":"Accept & See"},"formatCTAAcceptSend":{"original":"Accept & Send"},"formatCTAAcceptOnly":{"original":"Accept Only"},"formatCTAHelp":{"original":"Help"},"formatCTASendGiftBack":{"original":"Send a gift back"},"formatCTASendGift":{"original":"Send Gift"},"formatCTASendGifts":{"original":"Send Gifts"},"formatFFGiftSendTitle":{"original":"Help Fellow Farmers in FarmVille!"},"formatFFGiftSendBody":{"original":"Get a gift in return when your fellow farmers accept yours! Your fellow farmers are: {listNames}."},"formatFFGiftReceiveTitle":{"original":"Fellow Farmer {name1} sent you {gift}"},"formatGiftAggregateTitle":{"original":"You received {number} {gift}."},"formatGiftAggregateBody":{"original":"Accept gift and send a gift back to {listNames}?"},"formatGiftSingleTitle":{"original":"{name1} sent you {gift}."},"formatGiftSingleBody":{"original":"Accept gift and send a gift back to {name1}?"},"formatInviteAggregateTitle":{"original":"You have {number} {neighbors,object,count}.","variations":["You have {number} {neighbors,plural}.","You have {number} {neighbors,singular}."]},"neighbors":{"original":"a neighbor invitation","variations":{"indefinite_singular":"a neighbor invitation","singular":"neighbor invitation","plural":"neighbor invitations","indefinite_plural":"some neighbor invitations","definite_plural":"the neighbor invitations","definite_singular":"the neighbor invitation"}},"formatInviteAggregateSubText":{"original":"{listNames}"},"formatInviteAggregateBody":{"original":"Let them know you've accepted!"},"formatInviteSingleTitle":{"original":"{name1} wants to be your neighbor in {game}."},"formatInviteSingleBody":{"original":"Would you please accept?"},"formatHelpAggregateTitle":{"original":"Your friends need a {type}."},"formatHelpAggregateBody":{"original":"Let them know you would like to help."},"formatHelpAggregateSubText":{"original":"{listNames}"},"formatHelpSingleTitle":{"original":"{name1} sent:"},"formatHelpSingleBody":{"original":"Hey! Can you help me out by sending me a {type}?"},"formatFriendAggregateTitle":{"original":"Your friends need help building a {type}."},"formatFriendAggregateBody":{"original":"Let them know you are joining them."},"formatFriendAggregateSubText":{"original":"{listNames}"},"formatFriendSingleTitle":{"original":"{name1} sent:"},"formatFriendSingleBody":{"original":"I need you on the {crew} crew in my city!"},"formatNotifSingleTitle":{"original":"{name1} sent an item you requested."},"formatNotifSingleBody":{"original":"Send them a thank you gift!"},"formatNotifAggregateTitle":{"original":"Your friends sent items that you requested."},"formatNotifAggregateBody":{"original":"Send them a thank you gift!"},"formatNotifAggregateSubText":{"original":"{listNames}"},"formatExpiredTitle":{"original":"{number} {friends,object,count} sent you requests that have expired! Check back more often!","variations":["{number} {friends,plural} sent you requests that have expired! Check back more often!","{number} {friends,singular} sent you requests that have expired! Check back more often!"]},"formatExpiredBody":{"original":"Send {gift} as a thank you gift to: {listNames}"},"groupGift":{"original":"Gift"},"groupGifts":{"original":"Gifts"},"groupInvite":{"original":"Neighbor Invitation"},"groupInvites":{"original":"Neighbor Invitations"},"groupHelp":{"original":"Help Request"},"groupHelps":{"original":"Help Requests"},"groupFriend":{"original":"Friend Invite"},"groupFriends":{"original":"Friend Invites"},"groupFactory":{"original":"Factory Invite"},"groupFactories":{"original":"Factory Invites"},"groupNotif":{"original":"Notification"},"groupNotifs":{"original":"Notifications"},"groupRecommendation":{"original":"Recommended Neighbor"},"groupRecommendations":{"original":"Recommended Neighbors"},"groupExpired":{"original":"Expired Request"},"groupExpireds":{"original":"Expired Requests"},"groupFeed":{"original":"Gift"},"groupFeeds":{"original":"Gifts"},"feedPromptTitle":{"original":"Get a free {gift}"},"feedPromptContent":{"original":"When a friend claims the {gift}, you\u2019ll receive a free one, too!"},"feedPromptCTA":{"original":"Ask Friends"},"scrollhead":{"original":"Inbox"},"sendGift":{"original":"Send Gift"},"friends":{"original":"a friend","variations":{"indefinite_singular":"a friend","singular":"friend","plural":"friends","indefinite_plural":"some friends","definite_plural":"the friends","definite_singular":"the friend"}}}});
...
// Begin src/main.js
        /*global DAPI, FB, global, module, SNAPI, snid, ZLoc, ZSC, ZY*/
        (function (DAPI, FB, SNAPI, snid, ZLoc, ZSC, $) {
            'use strict';

            // Make a module
            var Inbox1P = (function (name) {
            ...
            var
                ...
                defaultGift = Inbox1P.defaultGift = {
                    ...
                    eventTypeId: 13002 //src/main.js:40//
                },
            ...
            a.set({
                ...
                // Maximum amount of time before the next poll is triggered. //src/main.js:90//
            ...
            // disable feed prompts to improve performance
            ...
            var signURL = Inbox1P.signURL = function (url, params) {
                ...
                return (sign !== undefined) ? sign(result) : result;
            };

        }(DAPI, FB, SNAPI, snid, ZLoc, ZSC, $));

// End src/main.js


// Begin src/getMessages.js
        /*global Inbox1P, snid, ZSC*/
        (function (Inbox1P, snid, ZSC, $) {
            var
                a = Inbox1P.a,
                atom = Inbox1P.atom,
                each = $.each,
            ...
            a.once(['gid', 'messagesURL'], function (gid, messagesURL) {
                var
                    getJSON = $.getJSON, //src/getMessages.js:20//
                    messageIDs = null
                    ;

                function handleMessages(response, onCompleteCallback) {
                    var messages = [], uids = [], prefixedUIds = {}, messagesAdded = false;
                    // Massage data into required format

                    if (!messageIDs) {
                        if (response["inQueueMessages"]) {
                            messageIDs = response["inQueueMessages"];
                        } else {
                            messageIDs = {};
                        }
                        // Set a flag to global mark the initialization of queuedMessages
                        a.set("inQueueMessages", true);
                    }

                    var response1 = response["allMessages"];

                    each(response1, function (evtId, evtData) {
                        messagesAdded = true;

                        // TODO JVL: May still need to validate evtId //src/getMessages.js:30//
                        ...
                        // Ensure uid is a string when we use it as a key in atom.
                            ...
                            addMessage = function () {
                                ...
                                var message = {
                                    id: evtId, //src/getMessages.js:50//
                                    sender: {
                                        zid: user.zid,
                                        name: user.name,
                                        snid: user.snid,
                                    ...
                                    snid: user.snid,
                                    game: gid,
                                    type: meta.expired ? 'expired' : meta.type, //src/getMessages.js:60//
                                    // Aggregate expired requests so they are displayed together.
                                    agg: meta.expired ? 'expired' : (
                                        ((meta.preventAggregation) || data.waitForServer) ?
                                            '' : meta.subtype
                                        ),
                                    ts: meta.timestamp,
                                    request_ids: {},
                                    data: data,
                                    loc: {} // optional
                                }; //src/getMessages.js:70//
                                if (message.agg === 'expired') {
                                    message.batchSize = 200;
                                } else if (message.agg === undefined) {
                                    delete message.agg;
                                }
                        ...
                        // Add additional info to the data param. //src/getMessages.js:80//
                        if (meta.subtype) {
                        ...
                        if (meta.type === 'other' && !meta.expired && meta.type_text) { //src/getMessages.js:90//
                            data.type_text = meta.type_text;
                        }
                        ...
                        if (meta.contentID) {
                            ...
                            { //src/getMessages.js:100//
                                data.waitForServer = true;
                            }
                        }
                        if (!meta.expired && evtData.data && evtData.data[0]) {
                            ...
                            //if (meta.type === 'other' || (meta.type === 'notif' && d.body)) { //src/getMessages.js:110//

                            data.body = d.body;

                        }

                        if (!messageIDs[msgKey]) {
                            // If we already have the user info, just add the message,
                            // otherwise, collect the uids and call addMessage after we
                            // retrieve the user info.
                            if (users.has(uid)) { //src/getMessages.js:120//
                                addMessage();
                            } else {
                                var uidParts = uid.split(':');
                                prefixedUIds[uidParts[uidParts.length - 1]] = uid;
                                uids.push(uid);
                                users.once(uid, addMessage);
                            }
                            messageIDs[msgKey] = true;
                        }
                    }); //src/getMessages.js:130//

                    if (onCompleteCallback && !messagesAdded) {
                        onCompleteCallback(0);
                    }
                    UserInfo.get(uids, 1, function (response) {
                        var msgCount = messages.length || 0;
                        // Cache user info in memory for later use.
                        each(response, function (id, map) {
                            users.set(prefixedUIds[id], {
                                zid: map.zid, //src/getMessages.js:140//
                                name: map.name,
                                snid: map.snid,
                                snuid: map.snuid,
                                pic: map.pic
                        ...
                        if (messages.length) {
                            a.set('messagesProcessed', messages);
                            ZSC.addRawMessages(messages, function () {
                                if (onCompleteCallback) { //src/getMessages.js:150//
                ...
                function fetch(onCompleteCallback, firstFetch) {
                    ...
                    if (!firstFetch || (get('messagesFetched') !== true)) {
                        ...
                        var getQ = false;
                        if (!get('inQueueMessages')) {
                            getQ = true;
                        }

                        getJSON(signURL(messagesURL, {firstFetch: getQ}), function (response) {
                            handleMessages(response, function (count) {
                                ZSC.InboxService.notifyFetchComplete();
                                onCompleteCallback();
                            }); //src/getMessages.js:170//
                        });
                    }
                    else {
                ...
                var messagePoller = session.poller(function () { //src/getMessages.js:180//
                    fetch(undefined, get('messagesFetched') !== true);
                ...
                function startFetchOnZSCOpened(firstFetch) {
                    ...
                    fetch(function () {
                        ZSC.hideSpinner();
                        ZSC.refreshMessages(); //src/getMessages.js:190//
                    }, firstFetch);
                }
...
// Begin src/groupSort.js
        ...
        (function (Inbox1P, ZSC) {
            ...
            ZSC.set({
                ...
                compareMessages: function (msgA, msgB) { //src/groupSort.js:30//
                ...
                groupMessage: function (message) {
                    ...
                    switch (message.type) {
                        ...
                        case 'crew':
                            return { singular: loc('groupCrew'), plural: loc('groupCrews') };
                        case 'factory':
                            return { singular: loc('groupFactory'), plural: loc('groupFactories') };
                        case 'notif': //src/groupSort.js:50//
                        ...
                        case 'recommendation':
                            return {
                                singular: loc('groupRecommendation'),
                                plural: loc('groupRecommendations')
                            };
                        case 'expired':
                            return { singular: loc('groupExpired'), plural: loc('groupExpireds') }; //src/groupSort.js:60//
                        default:
                ...
                formatMessage: function (aggMessage) {
                    var
                        message = {
                            ...
                            body: aggMessage.data.body,
							eventTypeId: ''
                        },
                        aggData = aggMessage.data,
                        subtype = aggData.subtype,
                        waitForServer = aggData.waitForServer, //src/displayMessage.js:50//
                        aggSubtype = aggData.subtype_aggregate || subtype,
                        firstUserName = aggMessage.senders[0].name,
                        len = aggMessage.ids.length
                        ;

                    if(aggMessage.data.ref) {
                        message.giftBackTracking = 'ref=' + aggMessage.data.ref;
                    }
                    ...
                    switch (aggMessage.type) {
                        case 'ffgGift':
                            if (aggData.contentID) {
                                ...
                                message.eventTypeId = aggMessage.type;
                            }
                            if (len > 1) {
                                message.title = loc('formatFFGiftSendTitle');
                                message.body = loc('formatFFGiftSendBody',
                                    { listNames: listNames(aggMessage.senders) });
                                message.primaryCTA = { key: 'send', text: loc('formatCTASendGift') };
                            } else {
								message.title = loc('formatFFGiftReceiveTitle',
                                    { name1: firstUserName, gift: aggData.subtype });
                                message.body = loc('formatGiftSingleBody', { name1: firstUserName });
                            if (aggMessage.data.body == 'accept_send') {
                                message.primaryCTA = { key: 'accept_send', text: loc('formatCTAAcceptSend') };
                            } else {
                        ...
                        case 'gift':
                            ...
                            if (aggData.contentID) {
                                message.contentID = aggData.contentID; //src/displayMessage.js:60//
                            }
                            ...
                            if (len > 1) {
                                ...
                                message.body = loc('formatGiftAggregateBody',
                                    { listNames: listNames(aggMessage.senders) }); //src/displayMessage.js:70//
                            ...
                            break; //src/displayMessage.js:90//
                        case 'invite':
                            if (len > 1) {
                                message.title = loc('formatInviteAggregateTitle',
                                    { number: len, neighbors: locTk('neighbors', '', len) });
                                message.subtext = loc('formatInviteAggregateSubText',
                                    { listNames: listNames(aggMessage.senders) });
                                message.body = loc('formatInviteAggregateBody');
                                message.primaryCTA = { key: 'accept', text: loc('formatCTAAcceptAll') };
                            } else {
                                message.title = loc('formatInviteSingleTitle', //src/displayMessage.js:100//
                        ...
                        case 'help':
                            if (len > 1) {
                                ...
                                message.title = loc('formatHelpAggregateTitle',
                                    { number: len, type: aggSubtype }); //src/displayMessage.js:110//
                                ...
                                // Single message.
                                message.title = loc('formatHelpSingleTitle', { name1: firstUserName });
                                //message.body = loc('formatHelpSingleBody',
                                //	{ type: aggMessage.data.subtype + '' });
                                message.primaryCTA = { key: 'accept', text: loc('formatCTAAccept') }; //src/displayMessage.js:120//
                            }
                            break;
                        case 'crew':
                        case 'factory':
                        case 'other':
                            if (len > 1) {
                                message.title = loc('formatFriendAggregateTitle',
                                    { number: len, type: aggSubtype });
                                message.body = loc('formatFriendAggregateBody');
                                message.subtext = loc('formatFriendAggregateSubText', //src/displayMessage.js:130//
                                    { listNames: listNames(aggMessage.senders) });
                                message.primaryCTA = { key: 'accept', text: loc('formatCTAAcceptAll') };
                            } else {
                                // Single message.
                                //message.title = loc('formatFriendSingleTitle',
                                //	{ name1: firstUserName });
                                //message.body = data.body;
                                message.primaryCTA = { key: 'accept', text: loc('formatCTAAccept') };
                            }
                            break; //src/displayMessage.js:140//
                        case 'notif':
                            if (len > 1) {
                                // Aggregate messages.
                                message.title = loc('formatNotifAggregateTitle',
                                    { number: len, type: aggSubtype });
                            ...
                            } else { //src/displayMessage.js:150//
                                // Single message.
                                message.title = loc('formatNotifSingleTitle', { name1: firstUserName });
                                //message.body = loc('formatNotifSingleBody');
                                message.primaryCTA = { key: 'accept_send', text: loc('formatCTASendGiftBack') };
                            }
                            break;
                        case 'expired':
                            len = aggMessage.senders.length;
                            message.title = loc('formatExpiredTitle',
                                { number: len, friends: locTk('friends', '', len) }); //src/displayMessage.js:160//
                            message.body = loc('formatExpiredBody',
                        ...
                        case 'feed':
                            ...
                            message.primaryCTA = aggData.primaryCTA; //src/displayMessage.js:170//
                            message.image = aggData.image;
                            break;
                        default:
                    ...
                    if (acceptAndSend && !waitForServer) {
                        switch (aggMessage.type) { //src/displayMessage.js:180//
                            case 'help':
                            case 'gift':
                                message.primaryCTA =
                                { key: 'accept_send', text: loc('formatCTAAcceptSend') };
                    ...
                    if (!aggMessage.expired && subtype) { //src/displayMessage.js:190//
                        message.subtype = subtype;
                        // Check for an image associated with the subtype. If one doesn't
                        // exist but is expected, it may stop the inbox from opening. Note:
                        // crew requests are a special case which have no associated image.
                        if (aggData.image) {
                            message.image = aggData.image;
                        }
                    }
                    return message;
                } //src/displayMessage.js:200//
            });
        ...
        (function (Inbox1P, ZSC, $) {
            ...
            function accept(message, callback) {
                Inbox1P.acceptRequest(
                    {
                        typeId: (message.type === 'ffgGift') ? 'ffgGift' : requestTypes[message.type],
            ...
            function send(message, callback) { //src/messageFlows.js:70//
                // TODO XXX: Post back chaining V1
                // TODO JVL: Wait for giftback? ui.v2.js#812; blocking on giftback
                if (message.eventTypeId == 'ffgGift') {
                    if ( message.senders.length > 0) {
                        var toUids = message.senders[0].snuid;
                        for (var i=1; i<message.senders.length; i++) {
                            toUids = toUids + ', ' + message.senders[i].snuid;
                        }
                        var isNonFBFriendRequestEnabled = false;
                        if (typeof(FarmNS) !== 'undefined' && FarmNS.FFG_NON_FB_FRIEND_REQ_ENABLED == true ) {
                            isNonFBFriendRequestEnabled = true;
                        }
                        if (isNonFBFriendRequestEnabled) {
                            Inbox1P.sendFbNotif({method: 'apprequests',
                                message: 'Hello Fello Farmer',
                                to: toUids
                            }, function(response) {
                                if (response && !response.error_code) {
                                    console.log('fb notification request completed.');
                                } else {
                                    console.log('Error while fb notification request sent.');
                                }
                            });
                        }
                    }
                ...
                Inbox1P.getGiftBackInputs(
                    ...
                    function (input_response) {
                        if (input_response.status === 'success') {
                            ...
                            if (eligible && eligible.snuids && eligible.snuids.length > 0) { //src/messageFlows.js:90//
                                Inbox1P.sendGift(
                                    {
// TODO JVL: May need to add other params; see data_shim.js#259-276
                                        ...
                                        sendkey: giftBack.sendkey, //src/messageFlows.js:100//
                                    ...
                                    function (gift_response) {
                                        switch (gift_response.status) {
                                            case 'cancel':
                                            case 'failure': //src/messageFlows.js:110//
                                                break;
                                            case 'success':
                                                break;
                                        }
                                        ...
                                        if (message.type === 'expired') {
                                            // After the user has sent a gift back in response to
                                            // expired gifts, we want to delete those expired
                                            // gifts in the background.
                                            Inbox1P.ignoreRequests(message.ids); //src/messageFlows.js:120//
                                        }
            ...
            function sendClientNotifications(response) {
                function checkForClientNotification(obj) {
                    if (!obj.hasOwnProperty('failureType')) { //src/messageFlows.js:140//
                        var clientNotification = obj.clientNotification;
                        if (clientNotification && window[clientNotification]) {
                            clientNotification = window[clientNotification];
            ...
            ZSC.set('followUp', function (message, action, callback) {
                var followUp = {
                    ...
                    type: message.type,
                    timestamps: message.timestamps //src/messageFlows.js:170//
                };
                ...
                function trackStatus(response) {
                    ...
                    if (response.failure) {
                        ZSC.set('accept-failure', { //src/messageFlows.js:190//
                            action: action,
                            message: message,
                    ...
                    if (response.sendResponse) {
                        ZSC.set('send-complete', {
                            action: action,
                            message: message,
                            sendResponse: response.sendResponse //src/messageFlows.js:200//
                        });
                    }
                    if (response.totalGifts) {
                        ZSC.set('accept-status', {
                            ...
                            status: {
                                ...
                                expiredGifts: response.expiredGifts, //src/messageFlows.js:210//
                                otherGifts: response.otherGifts,
                ...
                switch (action) {
                    case 'accept':
                    case 'accept_only': //src/messageFlows.js:220//
                        ...
                        followUp.primaryCTA = { key: 'send', text: loc('followUpCTASendGift') }; //src/messageFlows.js:230//
                        ...
                        if (message.type === 'gift') {
                        ...
                        } else { //src/messageFlows.js:240//
                            followUp.contentID = defaultGift.id;

                            followUp.body = loc('followUpFriendBody', {
                            ...
                            if (message.type === 'invite') {
                                followUp.title = loc('followUpInviteTitle',
                                    { listNames: listNames(message.senders) }); //src/messageFlows.js:250//
                                followUp.body = loc('followUpInviteBody', {
                                    gift: defaultGift.name
                                });
                                followUp.primaryCTA =
                    ...
                    case 'accept_send':
                        ...
                        accept(message, function (response) {
                            ...
                            // or else use the default gift type. //src/messageFlows.js:270//
                            followUp.contentID = (response && response.contentID) ||
                                followUp.contentID || defaultGift.id;
                            if (message.eventTypeId) {
                                followUp.eventTypeId = message.eventTypeId;
                            }
                        ...
                        // No follow-up.
                        callback(); //src/messageFlows.js:280//
                        break;
                    ...
                    case 'accept_see':
                        ...
                        accept(message, function (response) {
                            ...
                            if (!response || !response.message) { //src/messageFlows.js:290//
                                callback();
                                return;
                            }
                    ...
                    default:
                        callback(); //src/messageFlows.js:320//
                        break;
                }
            });
        }(Inbox1P, ZSC, $));
...
// Begin src/giftBack.js
        ...
        (function (Inbox1P, SNAPI, ZSC, $) {
            ...
            Inbox1P.getGiftBackInputs = function (contentID, eventTypeId, senders, tracking, callback) {
...
// Begin src/feedPrompts.js
        /*global FB, Inbox1P, linger, SNAPI, ZSC*/
        (function (Inbox1P, FB, SNAPI, ZSC, linger, $) {
            var
                conf,
                a = Inbox1P.a,
                loc = Inbox1P.loc,
                ...
                lastPostTS = 'lastPost',
                store = linger.cache('feedPrompts'),
                feedItems = [], //src/feedPrompts.js:10//
                poster,
                ONE_HOUR_MINS = 60,
            ...
            function post(url, params, callback) {
                var signed = Inbox1P.signURL(url + '?callback=?'); //src/feedPrompts.js:30//
                $.getJSON(
                    signed,
                    params,
                    callback
            ...
            function post2(url, params, cb) {
                var signed = Inbox1P.signURL(url);
                $.post(Inbox1P.signURL(url), params, cb); //src/feedPrompts.js:40//
            }
            ...
            function track(params) {
                ...
                $.extend(payload, params); //src/feedPrompts.js:50//
            ...
            function conf2messages() {
                ...
                function makeMessage(fid, ts, avatarPicUrl, itemPicUrl, title, content, cta, feedType) {
                    return {
                        id: fid,
                        sender: fakeSender(avatarPicUrl),
                        snid: 1,
                        game: a.get('gid'), //src/feedPrompts.js:80//
                        type: 'feed',
                        agg: '',
                        ts: ts,
                        data: {
                            ...
                            body: content,
                            image: itemPicUrl,
                            primaryCTA: { key: 'accept_feed', text: cta }
                        },
                        request_ids: {}, //src/feedPrompts.js:90//
                        feed_type: feedType
                    };
                }
                ...
                if (conf.feed.feeds) {
                    ...
                    fd = [ { //src/feedPrompts.js:100//
                        avatarPicUrl: conf.feed.avatarPicUrl,
                        itemPicUrl: conf.feed.itemPicUrl,
                        title: conf.feed.strings.title,
                        content: conf.feed.strings.content,
                        cta: conf.feed.strings.cta,
                        feedType: conf.feed.feedType
                    } ];
                }

                var rightNow = new Date(); //src/feedPrompts.js:110//
                ...
                if (messages.length > 0) {
                    track({genus: 'view'}); //src/feedPrompts.js:120//
            ...
            // TODO: refactor. city-specific
            function shouldDisplayPrompt() {
                if(ZSC_FEEDS) {
                    ZSC.set('showFeedPrompt', true); //src/feedPrompts.js:130//
                ...
                /*				
                 ...
                 'ztrack.experiment',
                 {
                 testName: 'fv_zsc_feeds',
                 variants: 4,
                 zid: parseInt(ZSC.a.get('zid'), 10)
                 }, //src/feedPrompts.js:140//
                 function (result) {
                 //Inbox1P.info( result );
            ...
            a.once(['feedConf', 'gid'], function (c, g) {
                ...
                shouldDisplayPrompt(); //src/feedPrompts.js:160//
                conf = c;
                ...
                a.once('showFeedPrompt', function () {
                    ...
                    var cooldown = conf.feed.cooldown !== undefined ? conf.feed.cooldown : DEFAULT_COOLDOWN_FEEDS_MINS;
            ...
            Inbox1P.postFeed = function (fid) {
                ...
                function success(response, inputs) {
                    ...
                    if (conf.feed.success) {
                        conf.feed.success(response, inputs); //src/feedPrompts.js:210//
                    }
                }
                ...
                function jpCallback(inputs) {
                    ...
                    Inbox1P.info(inputs); //src/feedPrompts.js:220//
                    ...
                    SNAPI.api(
                        ...
                        function (response) {
                                ...
                                response.hasOwnProperty('error_code'))
                            {
                                ...
                                SNAPI.api( //src/feedPrompts.js:240//
                                    'stream.publish',
                                    { payload: payload },
                                    function (response2) {
                                        if (response2) {
                                            if (response2.hasOwnProperty('error_code')) {
                                                error(
        ...
        }(Inbox1P, FB, SNAPI, ZSC, linger, $));
        //src/feedPrompts.js:290//
...
// Begin src/feedPromptConf.js
        ...
        (function (Inbox1P) {
            ...
            a.once(['assetURL', 'gameName'], function (url, gameName) {
                a.set('feedConf', {
                    gameName: gameName,
                    usePlainJson: true, //src/feedPromptConf.js:10//
                    feed:
                    {

                        feedType: ZSC_FEED_TYPE,
                        avatarPicUrl: ZSC_AVATAR_PIC_URL,
                        itemPicUrl: ZSC_ITEM_PIC_URL,

                        strings: {
                            title: loc('feedPromptTitle',
                                { gift: ZSC_FEEDS_ITEM_FRIENDLY_NAME }), //src/feedPromptConf.js:20//
                            content: loc('feedPromptContent',
                                { gift: ZSC_FEEDS_ITEM_FRIENDLY_NAME }),
                            cta: loc('feedPromptCTA')
                        },

                        // Callback for a successful feed post
                        success: function (snapiResponse, inputs) {
                            if (typeof(FarmNS) !== 'undefined' && typeof(FarmNS.StatsManager) !== 'undefined') {
                                FarmNS.StatsManager.count('zsc_feeds','success','snapi_stream_publish');
                            } //src/feedPromptConf.js:30//
                        },

                        // Callback for a failed feed post
                        error: function (snapiResponse) {
                            if (typeof(FarmNS) !== 'undefined' && typeof(FarmNS.StatsManager) !== 'undefined') {
                                FarmNS.StatsManager.count('zsc_feeds','errors','snapi_stream_publish');
                            }
                        },

                        // The minimum amount of time in minutes to wait before showing another feed prompt. //src/feedPromptConf.js:40//
                        // If not specified or set to undefined then a default of 4 hours is used.
                        cooldown: ZSC_FEEDS_THROTTLE_TIME
                    }
                });
            });
        }(Inbox1P));
